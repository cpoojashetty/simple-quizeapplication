...
public class playActivity extends AppCompatActivity {
    String[] question_list = {"What is the capital of France?",
    ...
    "Select the fruits from the list."
    };
    String[] choose_list = {"Paris","London","Rome","Berlin",
            "Red","Green","Violet","Grey",
            "New delhi","karnataka","Tamilnadu","Madhya pradesh",
            "mouse","monitor","keyboard","car",
            "apple","carrot","onion","tomato"
    };
    String[] correct_list = {"Paris","Red","New delhi","car","apple"};
